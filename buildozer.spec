...
# This is important for foreground service to keep bot alive
...
# HD content. You could first change the title to "(demo)" in the profile
...
#
#buildozer android debug profile=demo
